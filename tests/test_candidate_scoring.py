...
# def test_candidate_scoring_with_weighted_coverage():
#     engine = CandidateScoringEngine()
...
#     hard_result = HardRequirementResult(
#         passed=True, coverage_score=0.8, matched_required=["Python"], missing_required=["Go"],
...
#     # Compliance score = 0.8 * 100 = 80.0
#     assert score_profile.component_scores["compliance"] == 80.0
#     assert score_profile.component_scores["hard_requirements"] == 80.0
#     # Weighted score: 0 * 0.5 (skills) + 80.0 * 0.5 (compliance) = 40.0
#     assert score_profile.overall_score == 40.0
...
def test_candidate_scoring_uses_weighted_coverage():
    """
    Verify CandidateScoringEngine uses weighted hard requirement coverage
    ...
    # First check whether EvaluationStrategy has
    # a "hard_requirements" or "compliance" weight.  
